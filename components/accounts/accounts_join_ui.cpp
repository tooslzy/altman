			...
			thread([placeId_val, jobId_str, cookie = it->cookie, account_id = it->id]()
				{
					...
					LOG_INFO(
						"Launching Roblox for account ID: " + std::to_string(account_id) + " PlaceID: " + std::to_string
					...
					if (proc)
					{
						...
						LOG_INFO(
							"Roblox launched successfully for account ID: " + std::to_string(account_id) + " PlaceID: "
					...
					else
					{
						...
						LOG_ERROR(
							"Failed to start Roblox for account ID: " + std::to_string(account_id) + " PlaceID: " + std
